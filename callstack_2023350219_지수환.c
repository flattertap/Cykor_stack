...
void pop();
void function_prologue(const char* func_name, int local_count);
...
void func1(int arg1, int arg2, int arg3)
{
    ...
    push(arg2, "arg2");
    push(arg1, "arg1");
    function_prologue("func1 SFP", 1);
    call_stack[FP+1] = var_1;
    strcpy(stack_info[FP+1], "var_1");
    print_stack();
    func2(11, 13);
...
void func2(int arg1, int arg2)
{
    ...
    function_prologue("func2 SFP", 1);
    call_stack[FP+1] = var_2;
    strcpy(stack_info[FP+1], "var_2");
    print_stack();
    func3(77);
...
void func3(int arg1)
{
    ...
    push(arg1, "arg1");
    function_prologue("func3 SFP", 2);
    call_stack[FP+1] = var_3;
    strcpy(stack_info[FP+1], "var_3");
    call_stack[FP+2] = var_4;
    strcpy(stack_info[FP+2], "var_4");
    print_stack();
}
